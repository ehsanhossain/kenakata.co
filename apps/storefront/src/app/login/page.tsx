...
import { Phone, Mail, Lock, ArrowRight, ShieldCheck, CheckCircle2, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950">
      <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-800 overflow-hidden">
        {/* Header Banner */}
        <div className="p-8 bg-gradient-to-br from-brand-charcoal to-slate-800 text-white">
        ...
        <div className="p-8">
          {errorMsg && (
            <div className="flex items-center gap-2 p-3 mb-4 text-xs text-rose-600 bg-rose-50 dark:bg-rose-950/40 rounded-xl border border-rose-200 dark:border-rose-900/50">
          ...
          {activeTab === 'otp' && !otpStep && (
            <form onSubmit={handleSendOtp} className="space-y-4">
              <div>
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="w-full pl-24 pr-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white font-medium focus:ring-2 focus:ring-brand-emerald outline-none"
                  />
                </div>
              </div>
              ...
              <button
                ...
                className="w-full py-3.5 bg-brand-emerald hover:bg-emerald-600 text-white font-semibold rounded-xl shadow-lg shadow-emerald-500/20 flex items-center justify-center gap-2 transition-all"
              >
                <span>{isSubmitting ? 'Sending...' : isBn ? 'ওটিপি কোড পাঠান' : 'Send Login Code'}</span>
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full text-center text-2xl tracking-[0.4em] font-bold py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white outline-none focus:ring-2 focus:ring-brand-emerald"
                />
              </div>
          ...
          {activeTab === 'password' && (
            <form onSubmit={handlePasswordLogin} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white text-sm outline-none focus:ring-2 focus:ring-brand-emerald"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full py-3.5 bg-brand-charcoal hover:bg-slate-800 text-white font-semibold rounded-xl shadow-lg flex items-center justify-center gap-2 transition-all"
              >
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-medium rounded-xl border border-slate-200 dark:border-slate-700 flex items-center justify-center gap-3 transition-colors text-xs font-semibold"
          >
