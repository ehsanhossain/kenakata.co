...
const categoryMeta = {
  'Gadgets': {
    ...
    icon: 'gadgets',
    subcategories: {
      'Camera': { slug: 'camera', en: 'Security & Action Cameras', bn: 'ক্যামেরা ও সিসিটিভি', icon: 'camera' },
      'Earbuds': { slug: 'earbuds', en: 'Earbuds & Audio', bn: 'ইয়ারবাডস ও হেডফোন', icon: 'earbuds' },
      'Electronics': { slug: 'electronics', en: 'Smart Electronics & Gadgets', bn: 'স্মার্ট ইলেকট্রনিক্স ও গ্যাজেটস', icon: 'electronics' },
      'Fan': { slug: 'fan', en: 'Rechargeable Fans', bn: 'রিচার্জেবল ও পোর্টেবল ফ্যান', icon: 'fan' },
      'Light': { slug: 'light', en: 'Smart Lights & Lamps', bn: 'স্মার্ট লাইট ও ল্যাম্প', icon: 'light' },
      'Mobile Accessories': { slug: 'mobile-accessories', en: 'Mobile Accessories', bn: 'মোবাইল এক্সেসরিজ ও পাওয়ার ব্যাংক', icon: 'mobile-accessories' },
      'Mobile Phone': { slug: 'mobile-phone', en: 'Feature & Mini Phones', bn: 'ফিচার ও মিনি ফোন', icon: 'mobile-phone' },
      'Mouse & Keyboard': { slug: 'mouse-keyboard', en: 'Keyboards & Mice', bn: 'কীবোর্ড ও মাউস', icon: 'mouse-keyboard' },
      'Pillow': { slug: 'pillow', en: 'Comfort & Health Pillows', bn: 'পিলো ও ব্যাক সাপোর্ট', icon: 'pillow' },
      'Printer': { slug: 'printer', en: 'Thermal & Label Printers', bn: 'থার্মাল প্রিন্টার', icon: 'printer' },
      'Speaker': { slug: 'speaker', en: 'Bluetooth Speakers & Sound', bn: 'ব্লুটুথ স্পিকার ও অডিও', icon: 'speaker' },
      'UPS': { slug: 'ups', en: 'Mini Router UPS', bn: 'মিনি রাউটার ইউপিএস', icon: 'ups' },
    }
  },
  'Home Appliance': {
    slug: 'home-appliance',
    ...
    icon: 'home-appliance',
    subcategories: {
      'Bed Sheets': { slug: 'bed-sheets', en: '3D Bed Sheets & Bedding', bn: 'থ্রিডি বেডশিট ও বেডিং', icon: 'bed-sheets' },
    }
  }
};
