  ...
  if (wishlistItems.length === 0) {
    return (
      <div className="container-page py-20 text-center">
        ...
        <h1 className="text-xl font-semibold text-brand-charcoal mb-2">Your wishlist is empty</h1>
        <p className="text-sm text-neutral-500 mb-6">Save products you love and come back to them anytime.</p>
    ...
    <div className="container-page py-6 sm:py-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-neutral-500 mt-1">{wishlistItems.length} items saved</p>
        </div>
      </div>
