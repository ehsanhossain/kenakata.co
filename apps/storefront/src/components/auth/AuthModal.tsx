...
import {
  X, Phone, EnvelopeSimple, Lock, User, ArrowRight, ShieldCheck, CheckCircle, WarningCircle
...
export function AuthModal() {
 ...
 <div className="relative w-full max-w-md bg-white dark:bg-surface-subtle rounded-3xl shadow-2xl border border-border dark:border-border overflow-hidden">
 {/* Close Button */}
 <button
 onClick={closeAuthModal}
 className="absolute top-5 right-5 p-2 text-content-tertiary hover:text-content-secondary dark:hover:text-content-primary rounded-full bg-surface-subtle dark:bg-surface-muted transition-colors z-10"
 >
 <X className="w-5 h-5" />
 </button>

 {/* Modal Header */}
 <div className="px-8 pt-8 pb-6 bg-gradient-to-br from-brand-charcoal to-slate-800 text-content-primary relative">
 ...
 {/* Alerts */}
 {errorMsg && (
 <div className="flex items-center gap-2 p-3 mb-4 text-sm text-danger bg-danger-surface dark:bg-danger-surface rounded-xl border border-rose-200 dark:border-rose-900/50">
 ...
 : 'text-content-tertiary hover:text-content-primary dark:hover:text-content-secondary'
 }`}
 >
 ...
 <span className="absolute left-4 flex items-center gap-1 text-sm font-semibold text-content-secondary dark:text-content-secondary border-r border-border pr-3">
 🇧🇩 +880
 </span>
 <input
 type="tel"
 ...
 className="w-full pl-24 pr-4 py-3 bg-surface-subtle dark:bg-surface-muted border border-border rounded-xl text-slate-900 dark:text-content-primary font-medium focus:ring-2 focus:ring-action-primary/20 focus:border-transparent outline-none transition-all"
 />
 </div>
 ...
 className="w-full py-3.5 px-6 bg-action-primary hover:bg-emerald-600 text-content-primary font-semibold rounded-xl shadow-lg shadow-action-primary/10 flex items-center justify-center gap-2 transition-all transform active:scale-98 disabled:opacity-50"
 >
 <span>{isSubmitting ? (isBn ? 'কোড পাঠানো হচ্ছে...' : 'Sending Code...') : (isBn ? 'ওটিপি কোড পাঠান' : 'PaperPlaneTilt Login Code')}</span>
 ...
 className="w-full pl-11 pr-4 py-3 bg-surface-subtle dark:bg-surface-muted border border-border rounded-xl text-slate-900 dark:text-content-primary text-sm focus:ring-2 focus:ring-action-primary/20 focus:border-transparent outline-none"
 />
 </div>
 </div>
 ...
 <label className="text-xs font-semibold text-content-secondary dark:text-content-secondary uppercase tracking-wider">
 ...
 type="submit"
 disabled={isSubmitting}
 className="w-full py-3.5 px-6 bg-surface-inverse hover:bg-surface-muted text-content-primary font-semibold rounded-xl shadow-lg flex items-center justify-center gap-2 transition-all transform active:scale-98 disabled:opacity-50"
 >
 ...
 className="w-full py-3 px-4 bg-white dark:bg-surface-muted hover:bg-surface-subtle dark:hover:bg-surface-muted text-content-secondary dark:text-content-secondary font-medium rounded-xl border border-border flex items-center justify-center gap-3 transition-colors shadow-sm"
 >
 ...
 type="button"
 onClick={() => openAuthModal('register')}
 className="text-content-brand font-semibold hover:underline"
 >
 ...
 <div>
 <label className="block text-xs font-semibold text-center text-content-secondary dark:text-content-secondary uppercase tracking-wider mb-4">
 ...
 className="w-12 h-14 text-center text-xl font-bold bg-surface-subtle dark:bg-surface-muted border border-border rounded-xl text-slate-900 dark:text-content-primary focus:ring-2 focus:ring-action-primary/20 focus:border-transparent outline-none transition-all"
 />
 ))}
 </div>
 </div>
 ...
 <div className="flex items-center justify-between text-xs text-content-tertiary pt-2 border-t border-border dark:border-border">
 <button
 type="button"
 onClick={() => openAuthModal('login')}
 className="text-content-tertiary hover:text-content-primary dark:hover:text-content-secondary font-medium"
 >
 ...
 value={phoneNumber.replace('+880', '')}
 onChange={handlePhoneChange}
 className="w-full pl-24 pr-4 py-3 bg-surface-subtle dark:bg-surface-muted border border-border rounded-xl text-slate-900 dark:text-content-primary text-sm focus:ring-2 focus:ring-action-primary/20 focus:border-transparent outline-none"
 />
 </div>
 </div>
 ...
 <div className="text-center mt-4 text-xs text-content-tertiary">
